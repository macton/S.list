...
var list = {
  ...
  fgmap         : S.curry( function( f, g, list ) { return list.map( function( obj ) { return S.cv( S.cv(f,obj), S.cv(g,obj) ); }); } ),
  ...
  first         : function( list ) { return list?list[0]:null; },
  last          : function( list ) { return list?list[ list.length-1 ]:null; },
